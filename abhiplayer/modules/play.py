...
from abhiplayer.config import ARQ_API_KEY
...
async def yt(_, message: Message):
    ...
    if audio:
        ...
        title = file_name
        thumb_name = "https://telegra.ph/file/8cb0474e743a8545491a6.jpg"
...
async def lol_cb(b, cb):
    ...
    if cb.from_user.id != useer_id:
        ...
        return
    await cb.message.edit("**🎧 Ʌbhi Ƥɭɑyeɤ ɩs Ɲøω Sʈɑɤʈɩɳʛ ...**")
    x=int(x)
    try:
